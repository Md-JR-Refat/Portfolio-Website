        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <header className="mb-12">
            ...
            >
              ...
              >
                <Image
                  src="/MDJRRefat.jpg" // Create public/images folder and add your photo
                  alt="MD JR Refat Portrait"
                  width={256}
                  height={256}
              ...
              <div className="text-center md:text-left">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <AnimatedLink
                      href="tel:+8801974014286"
                      className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                    >
                      <PhoneIcon className="w-6 h-6" />
                      <span>+880 1974014286</span>
                    </AnimatedLink>
                  </motion.div>
                  ...
                  >
                    <AnimatedLink
                      href="https://github.com/Md-JR-Refat"
                      isExternal
                      className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                    >
                      <GitHubIcon className="w-6 h-6" />
                      <span>github.com/Md-JR-Refat</span>
                    </AnimatedLink>
                  </motion.div>
                  ...
                  >
                    <AnimatedLink
                      href="https://linkedin.com/in/mdjrrefat"
                      isExternal
                      className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                    >
                      <LinkedInIcon className="w-6 h-6" />
                      <span>linkedin.com/in/mdjrrefat</span>
                    </AnimatedLink>
                  </motion.div>
                </div>
              </div>
          ...
          <Section title="About Me" icon={<UserCircleIcon className="w-5 h-5" />}>
            <motion.p 
              ...
              transition={{ delay: 0.2 }}
            >
              A highly analytical and detail-oriented aspiring Data Scientist with a strong grasp of statistical analysis, data interpretation, and problem-solving. Proficient in R, and Python, with expertise in data visualization. Adept at breaking down complex datasets to uncover meaningful patterns and drive informed decision-making. Strong critical thinking skills enable me to approach challenges strategically and develop innovative, data-driven solutions. Passionate about harnessing the power of data to solve real-world problems and optimize processes.
            </motion.p>
          </Section>
          ...
          <Section title="Technical Expertise" icon={<CodeBracketIcon className="w-5 h-5" />}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <SkillCategory 
                title="Data Science" 
                items={["R", "SPSS", "Python", "Pandas", "NumPy","Excel"]}
              ...
              <SkillCategory
                title="AI Tools"
                items={["ChatGPT", "DeepSeek", " GitHub Copilot", "Gemini","Microsoft Copilot"]}
                color="text-orange-600 dark:text-orange-400"
              />
              <SkillCategory
                title="Tools & Platforms"
                items={["Git/GitHub", "Microsoft Word", "Microsoft Excel", "Microsoft PowerPoint","Prompt Engineering"]}
                color="text-orange-600 dark:text-orange-400"
              />
            </div>
          </Section>
          ...
          <Section title="Featured Projects" icon={<CommandLineIcon className="w-5 h-5" />}>
            <Project
              ...
              link="https://mdjrrefat.github.io/Portfolio-Website/"
            />
